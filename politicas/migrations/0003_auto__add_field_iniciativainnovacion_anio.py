...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IniciativaInnovacion.anio'
        db.add_column(u'politicas_iniciativainnovacion', 'anio',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IniciativaInnovacion.anio'
        db.delete_column(u'politicas_iniciativainnovacion', 'anio')
