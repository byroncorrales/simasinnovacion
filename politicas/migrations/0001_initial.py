...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'politicas_actividadempresarial', (
            ...
            ('tema_1', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='act_temauno', null=True, to=orm['politicas.TemasIncidencia'])),
            ('tema_2', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='act_temados', null=True, to=orm['politicas.TemasIncidencia'])),
            ('tema_3', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='act_tematres', null=True, to=orm['politicas.TemasIncidencia'])),
        ))
    ...
    models = {
        ...
        u'politicas.actividadempresarial': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tema_1': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'act_temauno'", 'null': 'True', 'to': u"orm['politicas.TemasIncidencia']"}),
            'tema_2': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'act_temados'", 'null': 'True', 'to': u"orm['politicas.TemasIncidencia']"}),
            'tema_3': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'act_tematres'", 'null': 'True', 'to': u"orm['politicas.TemasIncidencia']"})
        },
