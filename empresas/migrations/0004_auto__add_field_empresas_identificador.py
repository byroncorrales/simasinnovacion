...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Empresas.identificador'
        db.add_column(u'empresas_empresas', 'identificador',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Empresas.identificador'
        db.delete_column(u'empresas_empresas', 'identificador')
