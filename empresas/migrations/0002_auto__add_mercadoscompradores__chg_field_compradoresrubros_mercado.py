...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CompradoresRubros.mercado'
        db.alter_column(u'empresas_compradoresrubros', 'mercado_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['empresas.MercadosCompradores']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CompradoresRubros.mercado'
        db.alter_column(u'empresas_compradoresrubros', 'mercado_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['empresas.Mercados']))
