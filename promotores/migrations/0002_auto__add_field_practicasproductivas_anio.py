...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PracticasProductivas.anio'
        db.add_column(u'promotores_practicasproductivas', 'anio',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PracticasProductivas.anio'
        db.delete_column(u'promotores_practicasproductivas', 'anio')
