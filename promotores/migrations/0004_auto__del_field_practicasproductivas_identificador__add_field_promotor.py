...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Promotor.identificador'
        db.add_column(u'promotores_promotor', 'identificador',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Promotor.identificador'
        db.delete_column(u'promotores_promotor', 'identificador')
