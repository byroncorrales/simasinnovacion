...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PracticasProductivas.usuario'
        db.add_column(u'promotores_practicasproductivas', 'usuario',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Promotor.usuario'
        db.add_column(u'promotores_promotor', 'usuario',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PracticasProductivas.usuario'
        db.delete_column(u'promotores_practicasproductivas', 'usuario_id')

        # Deleting field 'Promotor.usuario'
        db.delete_column(u'promotores_promotor', 'usuario_id')
